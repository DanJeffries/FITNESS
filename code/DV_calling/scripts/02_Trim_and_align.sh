...
ITER_FILE=/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/sample_metadata/remaining_sample_paths.txt
...
## the trimmed files probably don't need to be kept. . . . lets see how it goes for now. 
