...
#SBATCH --export=NONE
#SBATCH --array=1-9236
#SBATCH --job-name=CALL_AND_PROCESS_VARIANTS_X
...
EXAMPLES_DIR=examples_X1n/$SAMPLE
...
CALL_VARIANTS_DIR=call_variants_X1n/$SAMPLE
...
POSTPROCESS_DIR=postprocess_variants_X1n/$COHORT/$SAMPLE
...
/opt/deepvariant/bin/postprocess_variants \
	...
	--nonvariant_site_tfrecord_path "/wd/GVCF_TFRECORDS_X1n/${SAMPLE}/${SAMPLE}_gvcf.tfrecord@${EXAMPLE_SHARDS}.gz" \
