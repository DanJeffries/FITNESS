...
#SBATCH --export=NONE
#SBATCH --array=8115,8041,8068,8134,8165,8552,8555
#SBATCH --job-name=CALL_AND_PROCESS_VARIANTS_cohort_9_leftovers
...
COHORT=cohort_9  ## output to cohort specific subdirs so that I can more easily give the path to GLnexus
