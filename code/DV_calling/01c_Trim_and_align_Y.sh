...
#SBATCH --export=NONE
#SBATCH --array=19-200
#SBATCH --job-name=Trim_and_align_cohort_1_Y
...
GENOME_IDX=/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/ref/BWA/GCF_016920845.1_GAculeatus_UGA_version5_genomic_shortnames_noX.fna
