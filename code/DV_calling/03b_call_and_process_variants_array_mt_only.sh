...
#SBATCH --export=NONE
#SBATCH --array=1-100
#SBATCH --job-name=CALL_AND_PROCESS_VARIANTS_cohort_1_mt
...
EXAMPLES_DIR=examples_mt/$SAMPLE
...
CALL_VARIANTS_DIR=call_variants_mt/$SAMPLE
...
COHORT=cohort_1  ## output to cohort specific subdirs so that I can more easily give the path to GLnexus
POSTPROCESS_DIR=postprocess_variants_mt/$COHORT/$SAMPLE
...
/opt/deepvariant/bin/postprocess_variants \
	...
	--nonvariant_site_tfrecord_path "/wd/GVCF_TFRECORDS_mt/${SAMPLE}/${SAMPLE}_gvcf.tfrecord@${EXAMPLE_SHARDS}.gz" \
