...
##SBATCH --mem=100G
#SBATCH --export=NONE
#SBATCH --job-name=GLNEXUS_cohort_1_mt
...
POSTPROCESS_DIR=$WD/postprocess_variants_mt/$COHORT ## input dir 
JOINT_CALLING_OUTDIR=$WD/GLnexus ## output dir

## splitting the joint calling into cohorts and by chromosome
CHROMOSOME_BED=/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/DV_calling/chr_beds/chr_mt.bed
