...
EXAMPLES_DIR=${WD}/examples_ALT/tune
OUTPUT_DIR=${WD}/examples_shuffled_ALT/tune
...
python3 ${SHUFFLE_SCRIPT_DIR}/shuffle_tfrecords_beam.py \
  ...
  --input_pattern_list="${EXAMPLES_DIR}/*tune_examples.ALT.tfrecord-0000*-of-00020" \
  --output_pattern_prefix="${OUTPUT_DIR}/tune_examples_inc_downsampled_05.shuffled" \
