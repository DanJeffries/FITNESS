...
EXAMPLES_DIR=${WD}/examples_shuffled_ALT/train/shuf_1 ## starting from outputs from shuffle 1 this time, no shuffle 2 for this test.
OUTPUT_DIR=${WD}/examples_shuffled_ALT/train/shuf_3
