...
if [ ! -d "$WD/examples_ALT/train" ]; then
   mkdir -p $WD/examples_ALT/train
fi
...
--confident_regions /wd/Confident_regions_ALT/${CROSS}_conf_regions_inc_vars_ALT.bed \
--examples /wd/examples_ALT/train/${SAMPLE}_training_examples_positional.tfrecord@20 \
