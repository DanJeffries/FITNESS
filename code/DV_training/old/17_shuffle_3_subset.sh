...
EXAMPLES_DIR=${WD}/examples_shuffled/train/shuf_2/working_example_subset ## starting from outputs from shuffle 2.
OUTPUT_DIR=${WD}/examples_shuffled/train/shuf_3
...
python3 ${SHUFFLE_SCRIPT_DIR}/shuffle_tfrecords_beam.py \
  ...
  --input_pattern_list="${EXAMPLES_DIR}/examples_shuffle2_*-000*-of-00020.tfrecord.gz" \
