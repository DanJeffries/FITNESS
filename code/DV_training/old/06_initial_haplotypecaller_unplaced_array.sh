...
#SBATCH --mem=99G
#SBATCH --export=NONE
#SBATCH --array=1-18  #52470
#SBATCH --job-name=HapCall_unplaced
...
GVCF=${GVCF_DIR}/${SAMPLE_NAME}_unplaced.g.vcf.gz

java -jar $GATK_PATH/bin/GenomeAnalysisTK.jar HaplotypeCaller \
	-R $GENOME \
	-I $BAM \
	-L /storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/DV_training/code/unplaced_contigs.list \
	-ERC GVCF \
	--output $GVCF
