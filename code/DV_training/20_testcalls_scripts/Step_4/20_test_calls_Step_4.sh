...
#SBATCH --export=NONE
#SBATCH --job-name=GRIDSEARCH_calls_STEP_4
#SBATCH --array=2-4
...
BEST_MODELS=/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/DV_training/20_testcalls_scripts/Step_4/best_checkpoints.txt
