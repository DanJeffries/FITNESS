...
#SBATCH --export=NONE
#SBATCH --job-name=GRIDSEARCH_calls_STEP_3
#SBATCH --array=1-3
...
BEST_MODELS=/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/DV_training/20_testcalls_scripts/Step_3/best_checkpoints.txt
