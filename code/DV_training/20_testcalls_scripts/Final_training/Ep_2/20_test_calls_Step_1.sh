...
#SBATCH --export=NONE
#SBATCH --job-name=FINAL_TRAINING_test_calls_Ep2
#SBATCH --array=1-4
...
BEST_MODELS=/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/DV_training/20_testcalls_scripts/Final_training/Ep_2/best_checkpoints.txt
