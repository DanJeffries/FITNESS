...
#SBATCH --export=NONE
##SBATCH --array=1-4
#SBATCH --job-name=TRAIN_tests_learning_rates_0_001_epoch2
...
--config.train_dataset_pbtxt="/home/examples_shuffled/train/shuf_test_large/examples_shuf3_largetestset_config.pbtxt" \
...
--config.init_checkpoint="/home/training_outs/param_tests/test_0.001_1024/checkpoints/ckpt-500"
