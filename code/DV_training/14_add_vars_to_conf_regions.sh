...
CROSS_CONF_REGION_BED=$CONF_BED_DIR/${CROSS}_nonVar_conf_regions_masked.bed
...
CROSS_CONF_WITH_VARS_BED=${CONF_BED_DIR}/${CROSS}_conf_regions_inc_vars.bed
...
CROSS_NONVAR_CONF_REGION_BED=$RESEARCH_DIR/7_Confident_nonVar_sites/Non_var_confident_regions/${CROSS}_nonVar_conf_regions_masked.bed
...
SUMMARY=$RESEARCH_DIR/8_Confident_regions/${CROSS}_conf_regions_summary.txt
