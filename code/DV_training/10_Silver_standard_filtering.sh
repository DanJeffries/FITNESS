...
bcftools filter -i 'FORMAT/AD[0:0]/(FORMAT/AD[0:0]+FORMAT/AD[0:1]) >= 0.85 | FORMAT/AD[0:1]/(FORMAT/AD[0:0]+FORMAT/AD[0:1]) >= 0.85' >  $FATHERS_VCF
...
bcftools filter -i 'FORMAT/AD[0:0] + FORMAT/AD[0:1] >= 10' | \
bcftools filter -i 'FORMAT/GQ >= 30' | \
bcftools filter -i 'FORMAT/AD[0:0]/(FORMAT/AD[0:0]+FORMAT/AD[0:1]) >= 0.85 | FORMAT/AD[0:1]/(FORMAT/AD[0:0]+FORMAT/AD[0:1]) >= 0.85' >  $MOTHERS_VCF
