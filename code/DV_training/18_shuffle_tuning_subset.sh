...
EXAMPLES_DIR=${WD}/examples_shuffled/tune/shuf_1/working_examples_subset
OUTPUT_DIR=${WD}/examples_shuffled/tune/shuf_2
...
python3 ${SHUFFLE_SCRIPT_DIR}/shuffle_tfrecords_beam.py \
  ...
  --output_pattern_prefix="${OUTPUT_DIR}/tune_examples_subset.shuffled" \
  --output_dataset_name="Shuffle_global" \
  --output_dataset_config_pbtxt="${OUTPUT_DIR}/tune_examples_subset.config.pbtxt" \
