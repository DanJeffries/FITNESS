...
#SBATCH --job-name=TRAIN_FINAL_EP3
...
STEP_PARAMS="/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/DV_training/19_training_scripts/Final_training/Ep_3/final_parameters.txt"
...
CHECKPOINTS="/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/DV_training/19_training_scripts/Final_training/Ep_3/best_checkpoints_from_Ep2.txt"
...
OUTDIR=FINAL_TRAINING/RUN_${RUN}/Epoch_3
...
--config.init_checkpoint="/home/FINAL_TRAINING/RUN_${RUN}/Epoch_2/checkpoints/${CHECKPOINT}"
