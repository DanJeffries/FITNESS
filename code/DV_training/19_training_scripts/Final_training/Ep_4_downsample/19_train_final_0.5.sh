...
#SBATCH --job-name=TRAIN_FINAL_EP4_downsample_05
...
OUTDIR=FINAL_TRAINING/RUN_${RUN}/Epoch_4_downsample_05
...
--config.train_dataset_pbtxt="/home/examples_shuffled_NEW/train/GRIDSEARCH_training_subset_with_downsampled_0.5_shuffled/examples_gridsearch_with_downsampled_0.5_shuffled.pbtxt" \
--config.tune_dataset_pbtxt="/home/examples_shuffled_NEW/tune_0.5/tune_examples.config.pbtxt" \
--config.num_epochs=1 \
