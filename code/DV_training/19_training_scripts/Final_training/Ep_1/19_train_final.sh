...
#SBATCH --export=NONE
#SBATCH --array=6  # start from 2 because of the header in the params file. 
#SBATCH --job-name=TRAIN_FINAL_EP1
...
STEP_PARAMS="/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/DV_training/19_training_scripts/Final_training//final_parameters.txt"
...
export APPTAINER_TMPDIR="/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/apptainer_tmp_${STEP}_${RUN}" #Set Singularity temporary dir
export TMPDIR="/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/parralel_tmp_${STEP}_${RUN}" #Set global temporary dir for parallel

# make outdir 

OUTDIR=FINAL_TRAINING/RUN_${RUN}
