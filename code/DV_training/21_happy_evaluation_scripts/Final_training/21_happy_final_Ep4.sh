...
#SBATCH --export=NONE
#SBATCH --array=1-3
#SBATCH --job-name=HAPPY_EVAL_Final_Ep3
...
BEST_MODELS=/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/DV_training/20_testcalls_scripts/Final_training/Ep_${EPOCH}_downsampling/best_checkpoints.txt
