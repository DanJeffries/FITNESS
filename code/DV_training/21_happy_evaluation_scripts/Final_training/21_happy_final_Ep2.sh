...
#SBATCH --export=NONE
#SBATCH --array=1-5
#SBATCH --job-name=HAPPY_EVAL_Final_Ep2
...
BEST_MODELS=/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/DV_training/20_testcalls_scripts/Final_training/Ep_${EPOCH}/best_checkpoints.txt
