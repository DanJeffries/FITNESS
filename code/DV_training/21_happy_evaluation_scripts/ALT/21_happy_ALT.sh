...
BEST_MODELS=/storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/DV_training/20_testcalls_scripts/ALT/best_checkpoints.txt

MODEL_DIR="/training_ALT_Ep3/checkpoints"
CHECKPOINT="ckpt-2000"
