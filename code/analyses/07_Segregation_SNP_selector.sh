...
#SBATCH --export=NONE
#SBATCH --array=1-22
#SBATCH --job-name=SNP_selector_segregation
...
python /storage/homefs/dj20y461/Stickleback/G_aculeatus/FITNESS/code/UTILS/Seg_tracking_SNP_selector.py /storage/research/iee_evol/DanJ/Stickleback/G_aculeatus/FITNESS/analyses/cohort_1/freq/ ${IDENTIFIER} $POPS $MIN_FREQ
